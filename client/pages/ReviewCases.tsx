        ...
        <div className="flex space-x-4 mb-4">
          ...
          <Select value={year} onValueChange={setYear}>
            ...
            <SelectContent>
               ...
               <SelectItem value="20">2023-24</SelectItem>
              <SelectItem value="23">2024-25</SelectItem>
              <SelectItem value="24">2025-26</SelectItem>
            </SelectContent>
          </Select>
          ...
          <table className="min-w-[1800px] border">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="p-2 border">ASMT ARN</th>
                <th className="p-2 border">ASMT Date</th>
                <th className="p-2 border">DRC-01</th>
                <th className="p-2 border">DRC-07</th>
                <th className="p-2 border">Recovery (Cr.)</th>
            ...
            <tbody>
              {filteredAssignments.map((a, i) => (
                <tr key={i}>
                  ...
                  <td className="p-2 border">{a.caseEntity.asmt10Arn}</td>
                  <td className="p-2 border">{a.caseEntity.asmt10IssueDate}</td>
                  <td className="p-2 border">{a.caseEntity.drc01}</td>
                  <td className="p-2 border">{a.caseEntity.drc07}</td>
                  <td className="p-2 border">{a.caseEntity.recoveryDoneCash ?? "-"}</td>
                  <td className="p-2 border">{a.caseEntity.remark}</td>
